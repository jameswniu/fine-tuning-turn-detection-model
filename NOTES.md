...
James's read holds: rvats already covers most of what the guide teaches (turn config, interruption handling, latency SLOs, evals, the telephony lane). What the guide has that rvats does not own yet, worth roadmap lines in the rvats repo once this repo ships:
...
Keep here until this repo ships, then move into the rvats README roadmap section.
