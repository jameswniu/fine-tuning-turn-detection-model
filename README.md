<p align="center">
  <img src="assets/hero.svg" alt="eot-detector: an end-of-turn detector for voice agents that scores 0.949 on a frozen human gold set with zero false interruptions, 0.913 on held-out real calls, and answers in 58 ms p95 on int8 CPU at threshold 0.42" width="100%">
</p>

<p align="center">
  <a href="https://github.com/jameswniu/eot-detector/actions/workflows/ci.yml"><img alt="ci" src="https://github.com/jameswniu/eot-detector/actions/workflows/ci.yml/badge.svg?branch=master"></a>
