...
def hero(c: dict) -> str:
    ...
    w, h = 1200, 360
    label = (
        f"voice-ai-turn-detection-evals: an end-of-turn detector for voice agents that scores {f['gold_pr_auc']} on a frozen "
    ...
    out.append(text(600, 52, "VOICE AI · END-OF-TURN DETECTION · EVALS", 22, AMBER, weight=700, anchor="middle", spacing=3))
    out.append(
