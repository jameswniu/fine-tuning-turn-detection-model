...
| v9 | 2026-08-25 | 1586 | 0.42 | 0.949 | 0.00 | 0.654 | 0.20 | 0.50 | 0.58 | 0.160 | pick_threshold now scores one row per call matching serving (int8 quantization is batch-composition-dependent); threshold 0.42; tier1 12/12; ood_test PR-AUC 0.913 false-speak 0.234 recall 0.959; regressions 6/6 |
...
| model | params | op threshold (int8, single-row) | gold PR-AUC | eval_es PR-AUC | ood_test PR-AUC (n 96) | ECE | tier-1 | role |
|---|---|---|---|---|---|---|---|---|
| eot-distilbert v9 | 66M | 0.42 | 0.949 | n/a (EN only) | 0.913 | 0.160 | 12/12 | ships as the default |
| mdistilbert-real2 | 135M | 0.97 | 0.979 | 1.00 | 0.875 | 0.35 | pass (4 admissible) | multilingual variant |
| scratch-pre | 7.4M | 0.79 | 0.973 | 1.00 | 0.825 | 0.062 | pass (guardrail-clean) | small fast lane |
| scratch-real | 7.4M | 0.95 | 0.994 | 0.996 | 0.597 | n/a | n/a | tradeoff exhibit (no pretrain) |
| scratch-pre2 | 7.4M | 0.98 | 0.976 | 1.00 | 0.810 | 0.107 | unsatisfiable | replication attempt |
...
- scratch-pre (own WordPiece tokenizer, small encoder, fifteen-minute MLM pretrain on our own corpora, real-call augmentation) is the from-scratch flagship: constrained dev-set pick at 0.79 with 60 admissible thresholds. At that operating point: gold false-speak 0.037 (one wait card of 27) with recall 0.923, Spanish false-speak 0.000 with recall 1.000, real calls false-speak 0.277 with recall 0.755. The checkpoint dir briefly carried a training-time 0.95 pick and the served dir won, per the same verify-the-artifact rule v8 bought. Served bench on the exact shipped artifact: 588 req/s at concurrency 8, wall p50 12.1 ms and p95 20.7 ms, model p50 about 5 ms.
